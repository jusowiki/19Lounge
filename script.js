...
document.querySelectorAll("[data-menu-category]").forEach(item => {

  item.addEventListener("click", async () => {

    const category = item.dataset.menuCategory;
